...
@Component({
  selector: 'app-renovasi-form',
  templateUrl: './renovasi-form.component.html',
  styleUrls: ['./renovasi-form.component.css']
})
export class RenovasiFormComponent implements OnInit {
  ...
  getHttp() {
    this.http.get<any>(environment.api + "support/getTicketNumber/"+this.model.userId+"/4", {
  ...
  onSubmit(){
    const body = {
      data : {userId : this.uId, subject : this.modelform.f1, note : this.model.note, supportFormId : 4, ticketNumber : this.ticketNumber},
    }
